...
public class ChunkRenderInfo {
	...
	SectionRenderDispatcher.RenderSection.RebuildTask.CompileResults renderData;
	SectionRenderDispatcher.RenderSection chunkRenderer;
	...
	void prepare(RenderChunkRegion blockView, SectionRenderDispatcher.RenderSection chunkRenderer, SectionRenderDispatcher.RenderSection.RebuildTask.CompileResults renderData, SectionBufferBuilderPack builders, Set<RenderType> initializedLayers) {
